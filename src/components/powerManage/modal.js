    ...
    return(
      <div className={styles.form+'shadow'} >
        <form>
         ...
         {/* {this.state.addresultsVisible?<div>
          <FormItem label='标题一:' hasFeedback {...formItemLayout}>
          ...
          <FormItem label='描述一:' hasFeedback {...formItemLayout}>
          ...
          <FormItem label='图片一：' hasFeedback {...formItemLayout}>
          ...
          {this.state.addresultsVisible?
          <Button className={styles.addsuccessget}  size='large' onClick={this.Hideresults}>隐藏成果物</Button>:
          <Button className={styles.addsuccessget}  size='large' onClick={this.Addresults}>添加成果物</Button>}*/}
