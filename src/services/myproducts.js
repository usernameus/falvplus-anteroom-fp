...
export async function creation (params) {
  return request(apisource + '/api/product', {
    method: 'post',
    data: params
  })
}
...
export async function queryLawyerName (params) {
  return request(apisource + '/api/firm/firmLawyer', {
    method: 'get',
  })
}

export async function deleteLawProduct (params) {
  return request(apisource + '/api/firm/unbundling/1', {
    method: 'get',
    data: params
  })
}

export async function addLawProduct (params) {
  return request(apisource + '/api/firm/unbundling/0', {
    method: 'get',
    data: params
  })
}
